...
Start with the [repository README](../README.md) for current image/tagging conventions and CI evidence. Review the repository workflows before changing the upstream digest, package set, patch overlay, or release behavior.
