...
#   litellm>=1.84.0           fixes CVE-2026-40217, CVE-2026-49468
#   starlette>=1.3.1          fixes CVE-2026-48818, CVE-2026-54283
#   tornado>=6.5.6            fixes CVE-2026-49853, CVE-2026-49855
...
RUN apk update \
    ...
    && apk upgrade --no-cache python-3.13 python-3.13-base py3-pip-wheel py3.13-pip py3.13-pip-base expat libcrypto3 libssl3 openssl busybox \
