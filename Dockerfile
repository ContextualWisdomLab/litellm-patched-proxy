...
# ⚡ Bolt Optimization: Use uv for significantly faster package installation and dependency resolution
RUN apk update \
    ...
    && python3 -m pip install --no-cache-dir --break-system-packages "uv==0.11.7" \
